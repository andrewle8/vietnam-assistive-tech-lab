...
1. Nhan Ctrl + S de luu.
2. Dung Alt + D de nhay len thanh dia chi, go duong dan USB (vi du: E:\)
3. Hoac dung "Luu thanh" (Ctrl + Shift + S) va chon USB tu danh sach ben trai.
...
| Ctrl + S | Luu |
| Ctrl + A | Chon tat ca |
| Ctrl + Shift + S | Luu thanh file moi |
