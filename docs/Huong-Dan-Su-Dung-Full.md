...
3. Vị trí lưu sẽ chỉ về USB của bạn.

### Lưu Tập Tin Vào USB

Lưu tất cả các tài liệu quan trọng vào USB của học sinh.
...
1. Nhấn **Ctrl + B** để mở tab Bookshelf (Kệ Sách): nếu đang ở Settings hoặc User Guide.
...
NVDA sẽ đọc tiêu đề sách và tiến độ đọc. Nhấn Control nếu muốn dừng giọng đọc.

Sau đó, khi đã sẵn sàng đọc sách, nhấn **Ctrl + P** để bắt đầu nghe sách.

### Phím Tắt Khi Đang Đọc Sách

Khi sách đã mở. **Các phím tắt này hoạt động khi tiêu điểm ở trên thanh công cụ trên cùng của Readmate.** Nếu Ctrl+P mở hộp thoại in thay vì bắt đầu đọc, tiêu điểm đang ở trên nội dung sách — nhấn F6 (hoặc Tab / Shift+Tab) để quay lại thanh công cụ.

**Quan trọng: tạm dừng TTS (Ctrl+P) trước khi nhấn bất kỳ phím điều hướng nào (Mũi tên xuống/lên, Alt+mũi tên, H).** Nhấn phím điều hướng khi đang phát sẽ làm trang cuộn nhanh và bỏ qua nội dung. Hãy tạm dừng trước, điều hướng, rồi Ctrl+P để tiếp tục.
