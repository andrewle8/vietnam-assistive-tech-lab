...
## Đọc Bách Khoa Offline Với Wikipedia Và Wiktionary
...
1. Trên Desktop, nhấn **W** để nhảy đến "Wikipedia" → nhấn **Enter**. Firefox sẽ mở trang chủ Kiwix.
...
4. Hoặc nhấn **Ctrl + Shift + U** trong Edge để bật "Đọc To" (Read Aloud) — Edge sẽ đọc tài liệu cho bạn bằng giọng tiếng Việt.
