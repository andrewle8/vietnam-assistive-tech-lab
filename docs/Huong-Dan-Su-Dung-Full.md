...
3. Nhấn **NVDA + Mũi tên xuống**: đọc toàn bộ bài viết.
...
3. Gõ chủ đề muốn tìm (ví dụ: "Việt Nam") → nhấn **Enter**. Một danh sách kết quả sẽ hiện ra với các mục từ cả hai cuốn sách.
...
| NVDA + A hoặc NVDA + Mũi tên xuống | Đọc liên tục (Say All)                                                |
| NVDA + L                          | Đọc lại dòng hiện tại                                                  |
